		...
		<div class="row container-xxl col-12 col-sm-10 col-md-8 col-lg-6 mx-auto">
			...
			<div class="card py-3 px-4 form-control" id="formulario-registro">
				...
				<form class="row g-3" method="POST" id="formRegisUser">
					...
					<div class="col-md-6 col-sm-6  mb-2 px-4 form-floating">
						<input type="text" class="form-control" id="cedula" name="cedula" id="floatingInput" placeholder="Cédula" maxlength="8">
					...
					<div class="col-md-6 col-sm-6  mb-2 px-4 form-floating">
						<input type="password" class="form-control" id="contra" name="password" id="floatingInput" placeholder="Contraseña" maxlength="8">
						<div class="error" id="errorContra"></div>
						<label for="floatingInput" class="ms-3">Contraseña <i class="fas fa-key"></i></label>
					</div>
					<div class="col-md-6 col-sm-6  mb-2 px-4 form-floating">
						<input type="password" class="form-control" id="contra2" name ="password2" id="floatingInput" placeholder="Repita Contraseña" maxlength="8">
