...
<head>
	...
	<link rel="stylesheet" type="text/css"  href="assets\css\eventos.css"></link>
...
<body>
	...
	<div class="container-fluid px-4">
		<div class="card mb-4 mt-4">
            <div class="card-header card-header-principal">
                ...
                <h1 class="m-0 d-inline">Gestión de Eventos</h1>
            </div>
			<nav style="--bs-breadcrumb-divider: '>';" class="p-2 nav-Breadcrumb" >
				<ol	ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="?url=dashboard&type=eventos">Eventos</a></li>
				</ol>
			</nav>
		</div>
            ...
            <div class="col">
                <div class="card mb-4">
                    <div class="card-header fs-5">
                        ...
                        Eventos
                        <button type="button" class="btn btn-primary h-25 mx-2 float-end" data-bs-toggle="modal" data-bs-target="#modalEventos" id="btnNuevoEvento"><i class="fa-solid fa-square-plus"></i></button>
                        <button type="button" class="btn btn-danger h-25 float-end" data-bs-toggle="modal" data-bs-target="#modalReporte" id="btnReporte"><i class="fa-solid fa-download"></i></button>
                    </div>
					<div class="card-body">

                        <div class="container-fluid table-responsive">
                            <table class="table table-striped" id="tblEventosdata">
                                <thead>
                                    <tr>
                                        <th class="tabla">Nroº de Evento</th>
                                        <th class="tabla">Nombre</th>
                                        <th class="tabla">Descripcion</th>
                                        <th class="tabla">Fecha</th>
                                        <th class="tabla">Hora de inicio</th>
                                        <th class="tabla">Categoria</th>
                                        <th class="tabla">Director</th>
                                        <th class="tabla">Imagen de Evento</th>
                                        <th>Acciones</th>
                                    </tr>
                                </thead>
                                <tbody id="tblEventos">
            ...
            <div class="col">
                <div class="card mb-4">
                    <div class="card-header fs-5">
                        ...
                        Categorías
                        <button type="button" class="btn btn-primary h-25 float-end" data-bs-toggle="modal" data-bs-target="#modalCateg" id="btnNuevaCategoria"><i class="fa-solid fa-plus"></i></button>
                    </div>
                    <div class="card-body">
                        <div class="container-fluid table-responsive">
                            <table class="table table-striped mb-4" id="tblCategdata">
                                <thead>
                                    <tr>
                                        <th class="tabla">Nroº de Categoría</th>
                                        <th class="tabla">Nombre de la Categoría</th>
                                        <th>Acciones</th>
                                    </tr>
                                </thead>
    ...
    <div class="modal fade" id="modalEventos" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="funcionForm" class="formularioEventos">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalTitleEventos"></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">

                        <div class="form-floating mb-3 col">
                                <input type="text" class="form-control" id="funcionNro" placeholder="Nroº de Función" require="" name="nroEvento" disabled readonly>
                                <label for="funcionNro">Nroº de Evento</label>
                        </div>

						<div class="form-floating mb-3 col">
                                <input type="text" class="form-control" id="funcionNombre" placeholder="Nombre del evento" require="">
                                <label for="funcionNombre">Nombre del Evento</label>
                                <div id="errorNom" class="erroresEvento"></div>
                        </div>

                        <div class="d-flex">

                            <div class="form-floating mb-3 me-3 col">
                                <input type="text" class="form-control" id="funcionDirec" placeholder="Director"  require="" >
                                <label for="funcionDirec">Director (Opcional)</label>
                                <div id="errorDirec" class="erroresEvento"></div>
                            </div>

							<div class="form-floating mb-3 col">
                                <input type="date" class="form-control" id="funcionFecha" require="" >
                                <label for="funcionFecha">Fecha de Realización</label>
                                <div id="errorFecha" class="erroresEvento"></div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="form-floating mb-3 me-3 col">
                                <input type="time" class="form-control" id="funcionHoraIni" require="">
                                <label for="funcionHora">Hora de Realización</label>
                                <div id="errorHoraIni" class="erroresEvento"></div>
                            </div>

							<div class="form-floating mb-3 col">
                                <input type="time" class="form-control" id="funcionHoraFin" require="">
                                <label for="funcionHora">Hora de Finalización</label>
                                <div id="errorHoraFin" class="erroresEvento"></div>
                            </div>
                        </div>
                        
                        <div class="form-floating mb-3">
                            <select class="form-select selectCateg" id="funcionCateg" require="">
                            </select>
                            <label for="funcionCateg">Categoria</label>
                            <div id="errorCateg" class="erroresEvento"></div>
                        </div>

                            <div class="form-floating mb-3 me-3 col-12">
                                <textarea class="form-control" placeholder="Descripción del Evento" id="describirFuncion"></textarea>
                                <label for="describirFuncion">Descripción del Evento</label>
                                <div id="errordescribir" class="erroresEvento"></div>
                            </div>

                        <div class="mb-3">
                            <label for="funcionFoto" class="form-label">Foto de Cartelera</label>
                            <input class="form-control form-control-sm" id="funcionFoto" type="file" >
                            <div id="errorFoto" class="erroresEvento"></div>
                        </div>
                         ...
                         <div class="form-check row">
							<div  class="row">
									<div class="form-check form-switch col-3">
										<input class="form-check-input" type="checkbox" role="switch" value="1" id="patioCheck">
										<label class="form-check-label mb-2" for="patioCheck">Patio</label>
									</div>
									<div class="form-check form-switch col-3">
										<input class="form-check-input" type="checkbox" value="1" id="palcosCheck">
										<label class="form-check-label mb-2" for="palcosCheck">Palcos</label>
									</div>
									<div class="form-check form-switch col-3">
										<input class="form-check-input" type="checkbox" role="switch" value="1"  id="galeriaCheck">
										<label class="form-check-label mb-2" for="galeriaCheck">Galeria</label>
									</div>
							</div>
                        </div>
                        <div id="errorArea" class="erroresEvento"></div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="enviarEvento" class="btn btn-success"><i class="fa-solid fa-check me-2"></i>Guardar</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="modalAsientos" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
			<form method="post" id="selectAsientos">
                <div class="modal-header">
                    <h5 class="modal-title fs-5" id="exampleModalToggleLabel"><i class="fa-solid fa-chair me-2"></i>Selección Asientos Palcos</h5>
                </div>
                <div class="modal-body">
					<div class="form-floating mb-3 col">
                        <input type="text" class="form-control" id="asientosNro" placeholder="Nroº de Función" require="" disabled readonly>
						<label for="funcionNro">Nroº de Evento</label>
                    </div>
					<div class="btn-group" role="group" style="display: flex; justify-content: center; align-items: center;" aria-label="Basic radio toggle button group">
						<input type="radio" class="btn-check" name="btnradio" id="BtnPat" autocomplete="off" checked>
						<label class="btn btn-outline-primary" for="BtnPat">Patio</label>

						<input type="radio" class="btn-check" name="btnradio" id="BtnPal" autocomplete="off">
						<label class="btn btn-outline-primary" for="BtnPal">Palcos</label>

						<input type="radio" class="btn-check" name="btnradio" id="BtnGal" autocomplete="off">
						<label class="btn btn-outline-primary" for="BtnGal">Galería</label>
					</div>
					<div class="mt-3 p-5 row">
							<div id="tablePat" class=" table-responsive-lg table-responsive-md">
								<div class="input-group input-group-sm mb-3">
										<input type="number" placeholder="Precio del area Patio" class="form-control" id="precioPatio" aria-label="Recipient's username" aria-describedby="basic-addon2">
										<span span class="input-group-text" id="basic-addon2">Bs</span>
								</div>
								<div id="errorPrecioPat"></div>
								<div id="seccionOeste">
									<div>
										<div class="row">
											<!-- Seccion -->
											<h4 class="text-light text-center btn btn-secondary" id="irSeccionEste">Sección Oeste 
												<span tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-placement="right" data-bs-content="Ir a la sección este"><i class="fas fa-circle-arrow-right"></i></span>
											</h4>
										</div>
										<div class="boleteria p-3 row">
								...
								<div id="seccionEste">
									<div>
										<div class="row">
											<!-- Seccion -->
											<button class="text-light text-center btn btn-secondary" id="irSeccionOeste">
												<span tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-placement="right" data-bs-content="Ir a la sección oeste"><i class="fas fa-circle-arrow-left"></i></span>
												Sección Este
											</button>
										</div>
										<div class="boleteria p-3 row">
							...
							<div id="tablePal" class="table-responsive-lg table-responsive-md">
								<div class="input-group input-group-sm mb-3">
										<input type="number" placeholder="Precio del area Palcos" class="form-control" id="precioPalco" aria-label="Recipient's username" aria-describedby="basic-addon2">
										<span span class="input-group-text" id="basic-addon2">Bs</span>
								</div>
								<div id="errorPrecioPal"></div>
								<div class="text-light row">
									<div class="col-6">
										<p class="text-black text-center fs-4">Balcon Oeste</h>
									</div>
									<div class="col-6">
										<p class="text-black text-center fs-4">Balcon Este</p>
									</div>  
								</div>
								<!-- Tabla -->
								<table class="table-bordered bg-light">
							...
							<div id="tableGal" class="table-responsive-lg table-responsive-md">
									<div class="input-group input-group-sm mb-3">
                                        <input type="number" class="form-control" placeholder="Precio del area Galería" id="precioGaleria" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                        <span span class="input-group-text" id="basic-addon2">Bs</span>
                                    </div>
									<div id="errorPrecioGal"></div>
								<div id="galeriaOeste">
									<div>
										<div class="row">
											<!-- Seccion -->
											<button class="text-light text-center btn btn-secondary" id="irGaleriaEste">Galería Oeste 
												<span tabindex="0"  data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-placement="right" data-bs-content="Ir a la galería este"><i class="fas fa-circle-arrow-right"></i></span>
											</button>
										</div>
										<div class="boleteria p-3 row">
											<div class="table-responsive-lg table-responsive-md">
								...
								<div id="galeriaEste">
									<div>
										<div class="row">
											<!-- Seccion -->
											<button class="text-light text-center btn btn-secondary" id="irGaleriaOeste">
												<span tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-placement="right" data-bs-content="Ir a la galería oeste"><i class="fas fa-circle-arrow-left"></i></span>
												Galería Este
											</button>
										</div>
										<div class="boleteria p-3 row">
													...
													<!-- Formulario -->
														<tbody class="text-center">
															...
															<tr>
																...
																<td class="p-2 vacio"><input type="checkbox" id="GC26"  class="checkAsi" name="asientoSelect[]" value="GC26"><label class="asiento" for="GC26"><i class="fas fa-chair h4"></i></label></td>
																<td class="p-2 vacio"></td>
																<td class="p-2 vacio bg-dark text-light">C</td>
															</tr>
															<tr>
						...
						<div id="ErroAsientos"></div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-danger" data-bs-dismiss="modal"><i class="fa-solid fa-circle-xmark me-2"></i>Cancelar</button>
						<button type="submit" form="selectAsientos" class="btn btn-success"><i class="fa-solid fa-check me-2"></i>Guardar</button>
					</div>
				</form>
            </div>
        </div>
    ...
    <div class="modal fade" id="modalCateg" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title fs-5" id="modalTitleCateg"></h5>
          ...
          <div class="modal-body">
            <form id="categoriaForm">
              <div class="mb-3">
                 <div class="form-floating mb-3 me-3 col">
                    <input type="text" class="form-control" id="nroCateg" disabled readonly>
                    <label for="funcionNro">Nroº de Categoría</label>
                </div>
              </div>
              <div class="mb-3">
                <div class="form-floating mb-3 me-3 col">
                    <input type="text" class="form-control" id="nombreCateg" placeholder="Nombre de la Categoría"  require="">
                     <label for="nombreCateg">Nombre de la Categoría</label>
                    <div id="errorNombreCateg"></div>
                </div>
              </div>
            </form>
          </div>
         <div class="modal-footer">
             <button type="button" class="btn btn-danger" data-bs-dismiss="modal"><i class="fa-solid fa-circle-xmark me-2"></i>Cancelar</button>
            <button type="submit" form="categoriaForm" id="nuevaCategoria" class="btn btn-success"><i class="fa-solid fa-check me-2"></i>Guardar</button>
            </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="modalReporte" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form method="POST" target="_blank" id="reporteEventos">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-floating mb-3  me-3 col">
                            <input type="date" class="form-control" name="fechaIniReporte" id="fechaIniReporte" require="">
                            <label for="fechaIniReporte">Desde:</label>
                            <div id="errorFechaIniReporte"></div>
                        </div>

                        <div class="form-floating mb-3  me-3 col">
                            <input type="date" class="form-control" name="fechaFinReporte"  id="fechaFinReporte" require="">
                            <label for="FechaFinReporte">Hasta:</label>
                            <div id="errorFechaFinReporte"></div>
                        </div>
						<div class="form-floating mb-3 me-3 col">
                            <select class="form-select selectCateg" name="categReporte" id="categReporte" require="">
                            </select>
                            <label for="categReporte">Categoria</label>
                        </div>
						<div class="form-floating mb-3 me-3 col">
                            <select class="form-select" id="estadoEventoReporte" name="estadoEventoReporte" require="">
								<option value="2">Todos</option>
								<option value="1">Activos</option>
								<option value="0">Finalizados</option>
                            </select>
                            <label for="estadoEventoReporte">Estado del Evento</label>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal"><i class="fa-solid fa-circle-xmark me-2"></i>Cancelar</button>
                        <button type="submit" name="generarReporteEventos" class="btn btn-success"><i class="fa-solid fa-check me-2"></i>Generar Reporte</button>
                    </div>
                </form>
            </div>
        </div>
...
<?php if(isset($crearReporte)){echo $crearReporte;} ?>
</body>
</html>